<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ResetPage.aspx.cs" Inherits="gymApplication.WebForm10" %>
                ...
                <div class="row">
                    <div class="form-group row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <asp:TextBox CssClass="rounded" ID="txtNewpassword" runat="server" placeholder="New Password" Height="40px" Width="250px"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="row">
